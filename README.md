...
- Contact fields validate required values and email format on input/submission, display nearby errors, and focus the first invalid field. Valid submissions are sent to the configured Formspree endpoint; invalid submissions stay on the page with inline feedback.
